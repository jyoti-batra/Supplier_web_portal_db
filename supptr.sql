...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 18, 2020 at 09:13 AM
...
CREATE TABLE `add_user` (
  ...
  `repeat_password` varchar(8) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='Add new user';

--
-- Dumping data for table `add_user`
--

INSERT INTO `add_user` (`username`, `email`, `password`, `repeat_password`) VALUES
('Jyoti Arora', 'jyoti3.a@tcs.com', 'tcs@9090', 'tcs@9090'),
('', 'Jyoti Arora', '', ''),
('', '', '', ''),
('', '', '', ''),
('', '', '', ''),
...
('', '', '', ''),
('', '', '', ''),
('Kushagra', 'jyoti3.a@tcs.com', 'tcs@1234', 'tcs@1234'),
('harshit123', 'test', 'ppp', 'test'),
('Jyoti Arora', '', 'tcs@9090', ''),
('Jyoti Arora', '', 'tcs@9090', ''),
('Jyoti Arora', '', 'tcs@9090', ''),
('12345', 'test', '222222', '11111'),
('onkar', 'onkar', '123456', '123456'),
('ok', 'tekinasolutionsandservcies5@gm', 'yes', 'yes'),
('ok', 'tekinasolutionsandservcies5@gm', 'yes', 'yes');
...
('1051', 'QMI USA Division', 0, 1051, 'QMI USA Division', '2020-08-06', '02:00:00', 'admin', '', '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0),
('2323', 'QMI Canada Division', 1, 2323, 'QMI Canada Division', '0000-00-00', '00:00:00', '', '', '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0),
('3011', 'Seating Division PA', 1, 3011, 'Seating Division PA', '0000-00-00', '00:00:00', '', '', '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0);
...
--
-- Table structure for table `role_mstr`
--

CREATE TABLE `role_mstr` (
  `role_role` varchar(30) NOT NULL,
  `role_name` varchar(40) NOT NULL,
  `role_add` varchar(3) NOT NULL,
  `role_update` varchar(3) NOT NULL,
  `role_delete` varchar(3) NOT NULL,
  `role_desc` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `role_mstr`
--

INSERT INTO `role_mstr` (`role_role`, `role_name`, `role_add`, `role_update`, `role_delete`, `role_desc`) VALUES
('Admin', 'Administration', 'yes', 'yes', 'yes', 'Administration'),
('BRM', 'BRM-Support', 'yes', 'yes', 'no', 'BRM-Support'),
('Customer', 'Customer', 'yes', 'yes', 'yes', 'Customer'),
('Reviewer', 'Reviewer', 'yes', 'yes', 'no', 'Reviewer'),
('SuperUser', 'Super User', 'yes', 'yes', 'no', 'SuperUser'),
('Supplier', 'Supplier', 'yes', 'yes', 'no', 'Supplier');
...
('20200729-103', '1051', '990164', '12097665', 12, 'SHP000002', 'P0-45035-02-EE', 'PO502231', 'PK021', 256, 'EA', '1', 'US', '10020', '2020-09-17', 'TRUCK', 'KNB20', 'HC2', 'DCK00211', '', 'S0-45035-02-EE', 'PLAT.4RH X1', '34', 'SD02', '2020-09-17', 'ATYP-4', 5436, '2020-09-17', '2020-09-18', '2020-09-01', 0, '2021-09-30', '', '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0, 'Read', '0000-00-00', '0000-00-00', 'no'),
...
CREATE TABLE `schd_ln_det` (
  ...
  `schd_ln_av` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `schd_ln_det` (`schd_ln_rlid`, `schd_ln_shipto`, `schd_ln_vend`, `schd_ln_part`, `schd_ln_order`, `schd_ln_line`, `schd_ln_date`, `schd_ln_ref`, `schd_ln_asnid`, `schd_ln_status`, `schd_ln_type`, `schd_ln_interval`, `schd_ln_qty`, `schd_ln_arr_date`, `schd_ln_learr_date`, `schd_ln_time`, `schd_ln_chr01`, `schd_ln_chr02`, `schd_ln_chr03`, `schd_ln_date01`, `schd_ln_date02`, `schd_ln_log01`, `schd_ln_log02`, `schd_ln_int01`, `schd_ln_int02`, `schd_ln_av`) VALUES
('20200709-001', '2323', '770152', 'P0-45035-02-CC', '64087455', 1, '2020-09-18', 'REF001', '', '', 'F', 'D', 40, '2020-09-18', '2020-09-20', '01:00:00', '', '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0, 30),
('20200709-001', '2323', '770152', 'P0-45035-02-CC', '64087455', 1, '2020-09-20', '', '', 'C', 'F', 'D', 30, '2020-09-20', '2020-09-21', '13:00:00', '', '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0, 0),
('20200709-001', '2323', '770152', 'P0-45035-02-CC', '64087455', 1, '2020-09-29', '', '', 'C', 'F', 'D', 75, '2020-09-29', '2020-09-30', '14:35:00', '', '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0, 0),
('20200709-001', '2323', '770152', 'P0-45035-02-ZZ', '64087455', 2, '2020-09-20', 'REF04', '', '', 'F', 'D', 80, '2020-09-20', '2020-09-20', '02:00:00', '', '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0, 80),
('20200709-001', '2323', '770152', 'P0-45035-02-QQ', '64087455', 3, '2020-09-27', 'TRM01', '', '', 'F', 'D', 100, '2020-09-27', '2020-09-29', '01:00:00', '', '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0, 100),
('20200709-001', '2323', '770152', 'P0-45035-02-QQ', '64087455', 3, '2020-10-10', 'TRM02', '', '', 'F', 'D', 100, '2020-10-10', '2020-10-15', '02:00:00', '', '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0, 100),
('20200709-001', '2323', '770152', 'P0-45035-02-ZZ', '64087455', 4, '2020-09-30', '', '', '', 'F', 'D', 300, '2020-09-30', '2020-10-04', '01:00:00', '', '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0, 300),
('20200709-002', '2323', '770152', 'P0-45035-02-EE', '64087455', 5, '2020-09-18', '', 'SHP000001', '', 'F', 'D', 100, '2020-09-18', '2020-09-19', '14:00:00', '', '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0, 50),
('20200709-002', '2323', '770152', 'PX-40035-02-EE', '64087455', 6, '2020-09-20', '', '', '', 'F', 'D', 200, '2020-09-20', '2020-09-21', '14:24:00', '', '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0, 200),
('20200709-002', '2323', '770152', 'PK-23625-01-00', '64087455', 8, '2020-09-21', '', '', '', 'F', 'D', 400, '2020-09-21', '2020-09-21', '16:00:00', '', '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0, 400),
('20200709-003', '2323', '770152', 'P0-45035-02-CX', '64087455', 1, '2020-09-20', '', '', '', 'F', 'D', 500, '2020-09-20', '2020-09-24', '01:00:00', '', '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0, 450),
('20200709-003', '2323', '770152', 'P0-45035-02-XX', '64087455', 2, '2020-09-20', '', '', '', 'F', 'D', 250, '2020-09-20', '2020-09-24', '01:00:00', '', '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0, 230),
('20200709-004', '2323', '770152', 'P0-45035-02-CC', '64087455', 21, '2020-09-30', '', 'SHP000002', '', 'F', 'D', 100, '2020-09-30', '2020-10-04', '01:00:00', '', '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0, 100),
('20200709-005', '2153', '770152', 'P0-45035-02-CC', '64087455', 22, '2020-09-30', '', 'SHP000005', '', 'F', 'W', 100, '2020-10-01', '2020-10-01', '01:00:00', '', '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0, 100),
('20200709-006', '2323', '770152', 'P1-10213-01-XY', '64087455', 9, '2020-09-27', '', 'TMP000001', 'C', 'F', 'D', 100, '2020-09-27', '2020-09-29', '01:00:00', '', '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0, 0),
('20200729-100', '1051', '990164', 'PY-40035-11-EE', '12097665', 1, '2020-09-19', 'RF0001', 'ASN000001', '', 'P', 'D', 100, '2020-09-19', '2020-09-19', '01:00:00', '', '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0, 100),
('20200729-100', '1051', '990164', 'P0-23625-01-00', '12097665', 2, '2020-09-19', 'RF0002', '', '', 'P', 'D', 200, '2020-09-19', '2020-09-19', '01:00:00', '', '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0, 200),
('20200729-100', '1051', '990164', 'P2-45035-02-EE', '12097665', 3, '2020-09-25', '', '', '', 'F', 'D', 300, '2020-09-25', '2020-09-25', '01:00:00', '', '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0, 300),
('20200729-101', '1051', '990164', 'P4-45045-02-XX', '12097665', 7, '2020-09-25', '', '', '', 'F', 'D', 100, '2020-09-25', '2020-09-29', '01:00:00', '', '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0, 100),
('20200729-101', '1051', '990164', 'P0-45035-02-CY', '12097665', 8, '2020-09-26', '', '', '', 'F', 'D', 200, '2020-09-26', '2020-09-29', '01:00:00', '', '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0, 200),
('20200729-102', '1051', '990164', 'P0-45035-02-EE', '12097665', 10, '2020-10-15', '', '', '', 'F', 'D', 400, '2020-10-15', '2020-10-15', '01:00:00', '', '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0, 400),
('20200729-103', '1051', '990164', 'P1-10113-01-CY', '12097665', 11, '2020-09-20', '', '', '', 'P', 'D', 500, '2020-09-20', '2020-09-20', '01:00:00', '', '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0, 500),
('20200729-103', '1051', '990164', 'P0-45035-02-EE', '12097665', 12, '2020-09-21', '', '', '', 'P', 'D', 500, '2020-09-21', '2020-09-21', '01:00:00', '', '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0, 500),
('20200729-103', '1051', '990164', 'P0-45035-02-EE', '12097665', 12, '2020-09-23', '', '', '', 'P', 'D', 300, '2020-09-23', '2020-09-23', '01:00:00', '', '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0, 300),
('20200729-103', '1051', '990164', 'P0-45035-02-EE', '12097665', 12, '2020-09-25', '', '', '', 'P', 'D', 500, '2020-09-25', '2020-09-25', '01:00:00', '', '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0, 500),
('20200729-103', '1051', '990164', 'P0-45035-02-EE', '12097665', 12, '2020-09-27', '', '', '', 'P', 'D', 500, '2020-09-27', '2020-09-27', '01:00:00', '', '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0, 500),
('20200729-103', '1051', '990164', 'P0-45035-02-EE', '12097665', 12, '2020-09-29', '', '', '', 'P', 'D', 500, '2020-09-29', '2020-09-29', '01:00:00', '', '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0, 500),
('20200729-103', '1051', '990164', 'P4-45045-02-XX', '12097665', 13, '2020-09-30', '', '', '', 'P', 'D', 500, '2020-09-30', '2020-09-30', '01:00:00', '', '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0, 500),
('20200729-103', '1051', '990164', 'P4-45045-02-XX', '12097665', 13, '2020-10-04', '', 'ASN000002', '', 'P', 'D', 500, '2020-10-04', '2020-10-04', '01:00:00', '', '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0, 500),
('20200729-104', '1051', '990164', 'P1-10113-01-CW', '12097665', 16, '2020-10-04', '', 'ASN000002', '', 'P', 'D', 250, '2020-10-04', '2020-10-04', '01:00:00', '', '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0, 250),
('20200729-105', '1051', '990164', 'P1-10113-01-CZ', '12097665', 13, '2020-09-27', '', 'ASN000003', '', 'F', 'D', 100, '2020-09-27', '2020-09-27', '01:00:00', '', '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0, 100),
('20200729-106', '1051', '990164', 'P1-10113-01-DX', '12097665', 14, '2020-09-29', '', 'TMP000002', '', 'F', 'M', 100, '2020-09-29', '2020-09-29', '01:00:00', '', '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0, 100),
('20200909-001', '3011', '100101', 'P3-20001-XX-01', 'SO120001', 1, '2020-09-25', '', 'TMP000003', '', 'F', 'D', 340, '2020-09-25', '2020-09-25', '04:00:00', '', '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0, 340),
('20200909-001', '3011', '100101', 'P3-20001-XX-01', 'SO120001', 1, '2020-09-29', '', 'TMP000003', '', 'F', 'D', 435, '2020-09-29', '2020-09-29', '04:00:00', '', '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0, 435),
('20200909-001', '3011', '100101', 'P3-20001-XX-01', 'SO120001', 1, '2020-10-05', '', 'TMP000003', '', 'F', 'D', 660, '2020-10-05', '2020-10-05', '04:00:00', '', '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0, 660),
('20200909-002', '3011', '100101', 'P3-20001-XX-02', 'SO120001', 2, '2020-10-05', '', 'TMP000003', '', 'F', 'D', 540, '2020-10-05', '2020-10-05', '04:00:00', '', '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0, 540),
('20200909-002', '3011', '100101', 'P3-20001-XX-02', 'SO120001', 2, '2020-10-09', '', 'TMP000003', '', 'F', 'D', 770, '2020-10-09', '2020-10-09', '04:00:00', '', '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0, 770),
('20200909-003', '3011', '100101', 'P3-20001-XX-03', 'SO120001', 3, '2020-10-11', '', 'TMP000003', '', 'F', 'D', 120, '2020-10-11', '2020-10-11', '04:00:00', '', '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0, 120),
('20200909-004', '3011', '100101', 'P3-20001-XX-04', 'SO120001', 4, '2020-10-13', '', 'TMP000003', '', 'F', 'D', 100, '2020-10-13', '2020-10-13', '04:00:00', '', '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0, 100);
...
CREATE TABLE `shpd_det` (
  ...
  `shpd_ASN_lineid` varchar(20) NOT NULL,
...
--
-- Dumping data for table `shpd_det`
--

INSERT INTO `shpd_det` (`shpd_id`, `shpd_vend_id`, `shpd_ship_to`, `shpd_par_id`, `shpd_itemnum`, `shpd_ponum`, `shpd_ASN_lineid`, `shpd_pick_num`, `shpd_shp_qty`, `shpd_cum_qty`, `shpd_qty_pkg`, `shpd_um`, `shpd_shpwt`, `shpd_COO`, `shpd_batchno`, `shpd_proddate`, `shpd_tracecode`, `shpd_kan`, `shpd_heatcode`, `shpd_dockcode`, `shpd_engcode`, `shpd_supp_item`, `shpd_itemdesc`, `shpd_chr01`, `shpd_chr02`, `shpd_chr03`, `shpd_date01`, `shpd_date02`, `shpd_log01`, `shpd_log02`, `shpd_int01`, `shpd_int02`) VALUES
(45, '2323', '770152', '', 'P1-10213-01-XY', 'PO102201', 'TMP-08-20-10001', 'PK011', '10', '70', '0', 'EA', '2', 'US', '10012', '0000-00-00', 'AIR', 'KNB12', 'HC2', 'DCK00101', '', 'S1-10213-01-XY', '', '20200709-006', '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0),
(46, '2323', '770152', '', 'P0-45035-02-CX', 'PO102201', 'TMP-08-20-10002', 'PK011', '50', '450', '0', 'EA', '0', 'US', '10008', '0000-00-00', 'RD', 'KNB08', 'HC2', 'DCK00101', '', 'S0-45035-02-CC', '', '20200709-003', '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0),
(47, '2323', '770152', '', 'P1-10213-01-XY', 'PO102201', 'TMP-08-20-10002', 'PK011', '5', '65', '0', 'EA', '2', 'US', '10012', '0000-00-00', 'AIR', 'KNB12', 'HC2', 'DCK00101', '', 'S1-10213-01-XY', '', '20200709-006', '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0),
(48, '2323', '770152', '', 'P0-45035-02-XX', 'PO102201', 'TMP-08-20-10002', 'PK011', '10', '240', '0', 'EA', '2', 'US', '10009', '0000-00-00', 'RD', 'KNB09', 'HC1', 'DCK00101', '', 'S0-45035-02-XX', '', '20200709-003', '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0),
(49, '2323', '770152', '', 'P0-45035-02-XX', 'PO102201', 'TMP-08-20-10003', 'PK011', '10', '230', '0', 'EA', '20', 'US', '10009', '0000-00-00', 'RD', 'KNB09', 'HC1', 'DCK00101', '', 'S0-45035-02-XX', '', '20200709-003', '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0),
(50, '2323', '770152', '', 'P1-10213-01-XY', 'PO102201', 'TMP-08-20-10003', 'PK011', '15', '50', '0', 'EA', '10', 'IN', '10012', '0000-00-00', 'AIR', 'KNB12', 'HC2', 'DCK00101', '', 'S1-10213-01-XY', '', '20200709-006', '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0),
(51, '2323', '770152', '', 'PX-40035-02-EE', 'PO102201', 'TMP-08-20-10004', 'PK011', '200', '0', '0', 'EA', '3', 'IN', '10006', '0000-00-00', 'RD', 'KNB06', 'HC2', 'DCK00101', '', 'SX-40035-02-EE', '', '20200709-002', '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0),
(52, '2323', '770152', '', 'P0-45035-02-EE', 'PO102201', 'TMP-08-20-10004', 'PK011', '50', '50', '0', 'EA', '20', 'GR', '10005', '0000-00-00', 'RD', 'KNB05', 'HC1', 'DCK00101', '', 'S0-45035-02-EE', '', '20200709-002', '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0),
(53, '2323', '770152', '', 'PK-23625-01-00', 'PO102201', 'TMP-08-20-10004', 'PK011', '400', '0', '0', 'EA', '0', 'IN', '10007', '0000-00-00', 'RD', 'KNB07', 'HC1', 'DCK00101', '', 'SK-23625-01-00', '', '20200709-002', '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0),
(54, '2323', '770152', '', 'P1-10213-01-XY', 'PO102201', 'TMP-08-20-10005', 'PK011', '50', '0', '0', 'EA', '0', '', '', '0000-00-00', '', '', 'HC2', 'DCK00101', '', 'S1-10213-01-XY', '', '20200709-006', '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0),
(55, '2323', '770152', '', 'P0-45035-02-CC', 'PO102201', 'TMP-08-20-10005', 'PK011', '30', '0', '0', 'EA', '2', 'US', '10001', '0000-00-00', 'AIR', 'KNB01', 'HC1', 'DCK00101', '', 'S0-45035-02-CC', '', '20200709-001', '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0),
(56, '2323', '770152', '', 'P0-45035-02-CC', 'PO102201', 'TMP-08-20-10005', 'PK011', '75', '0', '0', 'EA', '1', 'In', '11111', '0000-00-00', 'ARI', '', '', '', '', 'S0-45035-02-CC', '', '20200709-001', '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0),
(57, '2323', '770152', '', 'P0-45035-02-CC', 'PO102201', 'TMP-08-20-10005', 'PK011', '40', '0', '0', 'EA', '2', 'US', '10001', '0000-00-00', 'AIR', 'KNB01', 'HC1', '', '', 'S0-45035-02-CC', '', '20200709-001', '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0),
(58, '2323', '770152', '', 'P1-10213-01-XY', 'PO102201', 'TMP-08-20-10006', 'PK011', '100', '0', '0', 'EA', '2', 'US', '10012', '0000-00-00', 'AIR', 'KNB12', 'HC2', 'DCK00101', '', 'S1-10213-01-XY', '', '20200709-006', '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0),
(59, '2323', '770152', '', 'P0-45035-02-CC', 'PO102201', 'TMP-08-20-10006', 'PK011', '75', '0', '0', 'EA', '2', 'US', '10001', '0000-00-00', 'AIR', 'KNB01', 'HC1', 'DCK00101', '', 'S0-45035-02-CC', '', '20200709-001', '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0),
(60, '2323', '770152', '', 'P0-45035-02-CC', 'PO102201', 'TMP-08-20-10006', 'PK011', '30', '0', '0', 'EA', '2', 'US', '10001', '0000-00-00', 'AIR', 'KNB01', 'HC1', 'DCK00101', '', 'S0-45035-02-CC', '', '20200709-001', '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0),
(61, '2323', '770152', '', 'P0-45035-02-CC', 'PO102201', 'TMP-08-20-10006', 'PK011', '10', '30', '0', 'EA', '20', 'IN', '100011', '0000-00-00', '', 'KNB01', '', '23', '', 'S0-45035-02-CC', '', '20200709-001', '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0);
...
('770152', 'TMP-08-20-10001', '', '', '0000-00-00', '2020-08-17', '2020-08-17', '2323', '00:00:00', '01:27:00', '01:27:00', 'Asia/Cal', 'Asia/Cal', 'Asia/Cal', '', '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0, 0, '', '', '', '0', '', '', ''),
('770152', 'TMP-08-20-10002', '', '', '0000-00-00', '2020-08-17', '2020-08-17', '2323', '00:00:00', '01:27:00', '01:27:00', 'Asia/Cal', 'Asia/Cal', 'Asia/Cal', '', '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0, 0, '', '', '', '0', '', '', ''),
('770152', 'TMP-08-20-10003', 'Bol', '123qwerty', '0000-00-00', '2020-08-17', '2020-08-17', '2323', '00:00:00', '02:52:00', '02:52:00', 'Asia/Cal', 'Asia/Cal', 'Asia/Cal', '', '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0, 4, 'Railway', 'SHIP', '10013060', '0', '007abc', '1818', 'Safe Journey'),
('770152', 'TMP-08-20-10004', '', '', '0000-00-00', '2020-08-17', '2020-08-17', '2323', '00:00:00', '11:45:00', '11:45:00', 'Asia/Cal', 'Asia/Cal', 'Asia/Cal', '', '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0, 0, '', '', '', '0', '', '', ''),
('770152', 'TMP-08-20-10005', '', '', '0000-00-00', '2020-08-17', '2020-08-17', '2323', '00:00:00', '15:18:00', '15:18:00', 'Asia/Cal', 'Asia/Cal', 'Asia/Cal', '', '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0, 0, '', '', '', '0', '', '', ''),
('770152', 'TMP-08-20-10006', '123', '22', '0000-00-00', '2020-08-17', '2020-08-17', '2323', '00:00:00', '16:36:00', '16:36:00', 'Asia/Cal', 'Asia/Cal', 'Asia/Cal', '', '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0, 1, 'Air', 'TRUCK', '10013030', '0', '', '', '');
...
CREATE TABLE `usr_mstr` (
  ...
  `usr_vend` varchar(20) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `usr_mstr` (`usr_id`, `usr_usrid`, `usr_firstname`, `usr_lastName`, `usr_type`, `usr_active`, `usr_active_by`, `usr_active_date`, `usr_active_reason`, `usr_failed_attempts`, `usr_lang`, `usr_last_date`, `usr_logon_date`, `usr_logon_time`, `usr_logon_timezone`, `usr_mail_address`, `usr_passwd`, `usr_rmks`, `usr_ltmoddt`, `usr_ltmodtm`, `usr_ltmodusr`, `usr_roles`, `usr_cntry`, `usr_chr01`, `usr_chr02`, `usr_chr03`, `usr_date01`, `usr_date02`, `usr_log01`, `usr_log02`, `usr_int01`, `usr_int02`, `usr_timezone`, `usr_supp`, `usr_vend`) VALUES
('1', 'apaul', 'Abey', 'Paul', 'Supplier', 0, 'admin', '0000-00-00', 'SUPP_DEF', 0, 'US', '0000-00-00', '0000-00-00', '00:00:00', 'ist', '', 'pass123', 'Abey', '0000-00-00', '00:00:00', 'admin', '', 'IND', '', '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0, 'ist', 770152, '770152'),
('10', 'jwales', 'Jimmy', 'Wales', 'supplier', 0, 'admin', '0000-00-00', 'SUPP_DEF', 0, 'US', '0000-00-00', '0000-00-00', '00:00:00', 'pst/pdt', '', 'Passwd10$', 'Jimmy', '0000-00-00', '00:00:00', 'admin', '', 'USA', '', '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0, 'pst/pdt', 990164, '990164'),
('11', 'zwang', 'Zerry', 'Wang', 'supplier', 0, 'admin', '0000-00-00', 'SUPP_DEF', 0, 'US', '0000-00-00', '0000-00-00', '00:00:00', 'cst', '', 'Passwd11$', 'Zerry', '0000-00-00', '00:00:00', 'admin', '', 'CHN', '', '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0, 'cst', 990164, '990164'),
('12', 'lwayne', 'Lei', 'Wayne', 'customer', 0, 'admin', '0000-00-00', 'CUST_DEF', 0, 'US', '0000-00-00', '0000-00-00', '00:00:00', 'cst', '', 'Passwd12$', 'Lei', '0000-00-00', '00:00:00', 'admin', '', 'CHN', '', '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0, 'cst', 0, '0'),
('13', 'sarchb', 'Steven', 'Archbold', 'customer', 0, 'admin', '0000-00-00', 'CUST_DEF', 0, 'US', '0000-00-00', '0000-00-00', '00:00:00', 'pst/pdt', '', 'Passwd13$', 'Steven', '0000-00-00', '00:00:00', 'admin', '', 'USA', '', '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0, 'pst/pdt', 0, '0'),
('14', 'abrian', 'Allen', 'Brian', 'supplier', 0, 'admin', '0000-00-00', 'SUPP_DEF', 0, 'US', '0000-00-00', '0000-00-00', '00:00:00', 'pst/pdt', '', 'Passwd14$', 'Allen', '0000-00-00', '00:00:00', 'admin', '', 'USA', '', '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0, 'pst/pdt', 100101, '100101'),
('15', 'cmarcel', 'Chris', 'Marcel', 'supplier', 0, 'admin', '0000-00-00', 'SUPP_DEF', 0, 'US', '0000-00-00', '0000-00-00', '00:00:00', 'pst/pdt', '', 'Passwd15$', 'Chris', '0000-00-00', '00:00:00', 'admin', '', 'USA', '', '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0, 'pst/pdt', 100101, '100101'),
('16', 'dpeter', 'David', 'Peterson', 'Supplier', 0, 'admin', '0000-00-00', 'SUPP_DEF', 0, 'US', '0000-00-00', '0000-00-00', '00:00:00', 'pst/pdt', '', 'pass123', 'David', '0000-00-00', '00:00:00', 'admin', '', 'USA', '', '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0, 'pst/pdt', 100101, '100101'),
('17', 'mhoang', 'Hoang', 'Mai', 'supplier', 0, 'admin', '0000-00-00', 'SUPP_DEF', 0, 'US', '0000-00-00', '0000-00-00', '00:00:00', 'ict', '', 'Passwd17$', 'Hoang', '0000-00-00', '00:00:00', 'admin', '', 'VNM', '', '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0, 'ict', 100101, '100101'),
('18', 'admin', 'Harman', 'Krista', 'Admin', 0, 'admin', '0000-00-00', 'ADMN_DEF', 0, 'US', '0000-00-00', '0000-00-00', '00:00:00', 'pst/pdt', '', 'admin1!', 'Harman', '0000-00-00', '00:00:00', 'admin', '', 'USA', '', '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0, 'pst/pdt', 0, NULL),
('2', 'lray', 'Lisa', 'Ray', 'supplier', 0, 'admin', '0000-00-00', 'SUPP_DEF', 0, 'US', '0000-00-00', '0000-00-00', '00:00:00', 'pst/pdt', '', 'Passwd2$', 'Lisa', '0000-00-00', '00:00:00', 'admin', '', 'USA', '', '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0, 'pst/pdt', 770152, '770152'),
('3', 'sjose', 'Stephen ', 'Jose', 'supplier', 0, 'admin', '0000-00-00', 'SUPP_DEF', 0, 'US', '0000-00-00', '0000-00-00', '00:00:00', 'pst/pdt', '', 'Passwd3$', 'Stephen ', '0000-00-00', '00:00:00', 'admin', '', 'USA', '', '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0, 'pst/pdt', 770152, '770152'),
('4', 'karchb', 'Kevin', 'Archbold', 'supplier', 0, 'admin', '0000-00-00', 'SUPP_DEF', 0, 'US', '0000-00-00', '0000-00-00', '00:00:00', 'pst/pdt', '', 'Passwd4$', 'Kevin', '0000-00-00', '00:00:00', 'admin', '', 'USA', '', '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0, 'pst/pdt', 770152, '770152'),
('5', 'jfuter', 'John', 'Futers', 'supplier', 0, 'admin', '0000-00-00', 'SUPP_DEF', 0, 'US', '0000-00-00', '0000-00-00', '00:00:00', 'pst/pdt', '', 'Passwd5$', 'John', '0000-00-00', '00:00:00', 'admin', '', 'USA', '', '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0, 'pst/pdt', 770152, '770152'),
('6', 'sgardine', 'Simon', 'Gardiner', 'supplier', 0, 'admin', '0000-00-00', 'SUPP_DEF', 0, 'US', '0000-00-00', '0000-00-00', '00:00:00', 'pst/pdt', '', 'Passwd6$', 'Simon', '0000-00-00', '00:00:00', 'admin', '', 'USA', '', '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0, 'pst/pdt', 770152, '770152'),
('7', 'khorri', 'Keith', 'Horrigan', 'supplier', 0, 'admin', '0000-00-00', 'SUPP_DEF', 0, 'US', '0000-00-00', '0000-00-00', '00:00:00', 'pst/pdt', '', 'Passwd7$', 'Keith', '0000-00-00', '00:00:00', 'admin', '', 'USA', '', '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0, 'pst/pdt', 990164, '990164'),
('8', 'spritch', 'Steven', 'Pritchard', 'supplier', 0, 'admin', '0000-00-00', 'SUPP_DEF', 0, 'US', '0000-00-00', '0000-00-00', '00:00:00', 'pst/pdt', '', 'Passwd8$', 'Steven', '0000-00-00', '00:00:00', 'admin', '', 'USA', '', '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0, 'pst/pdt', 990164, '990164'),
('9', 'gchang', 'Glenn', 'Chang', 'supplier', 0, 'admin', '0000-00-00', 'SUPP_DEF', 0, 'US', '0000-00-00', '0000-00-00', '00:00:00', 'pst/pdt', '', 'Passwd9$', 'Glenn', '0000-00-00', '00:00:00', 'admin', '', 'USA', '', '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0, 'pst/pdt', 990164, '990164'),
('usr_id', 'usr_usrid', 'usr_firstname', 'usr_lastName', 'usr_type', 0, 'usr_active_by', '0000-00-00', 'usr_active_reason', 0, 'us', '0000-00-00', '0000-00-00', '00:00:00', 'usr_logon_timezo', 'usr_mail_address', 'usr_passwd', 'usr_rmks', '0000-00-00', '00:00:00', 'usr_ltmodusr', 'usr_roles', 'usr', 'usr_chr01', 'usr_chr02', 'usr_chr03', '0000-00-00', '0000-00-00', 0, 0, 0, 0, 'usr_timezone', 0, '0');
...
INSERT INTO `usr_status` (`id`, `usr_stat_id`, `usr_stat_type`, `usr_stat_site`) VALUES
(1, 'abrian', 'supplier', '1051'),
(2, 'admin', 'admin', '3011'),
(3, 'apaul', 'supplier', '2323'),
(4, 'cmarcel', 'supplier', '2323'),
(6, 'gchang', 'supplier', '1051'),
(7, 'jfuter', 'supplier', '2323'),
(8, 'jwales', 'supplier', '1051'),
(9, 'karchb', 'supplier', '2323'),
(10, 'khorri', 'supplier', '2323'),
(11, 'lray', 'supplier', '1051'),
(12, 'lwayne', 'customer', '3011'),
(13, 'mhoang', 'supplier', '1051'),
(14, 'sarchb', 'customer', '3011'),
(15, 'sgardine', 'supplier', '2323'),
(16, 'sjose', 'supplier', '2323'),
(17, 'spritch', 'supplier', '1051'),
(18, 'usr_stat_id', 'usr_stat', 'usr_stat_site'),
(19, 'zwang', 'supplier', '1051'),
(20, 'admin', 'admin', '1051'),
(21, 'admin', 'admin', '2323'),
(22, 'dpeter', 'supplier', '1051'),
(23, 'apaul', 'supplier', '1051');
...
--
-- Indexes for table `role_mstr`
--
ALTER TABLE `role_mstr`
  ADD PRIMARY KEY (`role_role`);
...
--
-- AUTO_INCREMENT for table `shpd_det`
--
ALTER TABLE `shpd_det`
  MODIFY `shpd_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=62;

--
-- AUTO_INCREMENT for table `usr_status`
--
ALTER TABLE `usr_status`
